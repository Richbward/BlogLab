...
namespace BlogLab.Web.Controllers
{
    ...
    public class BlogController : ControllerBase
    {
        ...
        public async Task<ActionResult<int>> Delete(int blogId)
        {
            ...
            if (foundBlog.ApplicationUserId != applicationUserId) return Unauthorized("You are not the author of this blog.");

            var affectedRow = await _blogRepository.DeleteAsync(blogId);
